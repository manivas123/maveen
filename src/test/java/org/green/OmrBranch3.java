...
public class OmrBranch3 {
   ...
   javasc.executeScript("arguments[0].setAttribute('value','2024-06-23')", element2);
	...
	driver.findElement(By.xpath("//button[contains(text(),'Search')]")).click();
     ...
     List<WebElement> searchhotel = driver.findElements(By.xpath("(//div[@class='col-md-5 hotel-suites']//h5)"));
	 for (int i = 0; i < searchhotel.size(); i++) {
		System.out.println(searchhotel.get(i).getText());
	}
